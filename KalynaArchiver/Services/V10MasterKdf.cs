...
internal static class V10MasterKdf
{
        ...
        Span<byte> destination)
    {
        ...
        try
        {
            ...
            WriteLengthPrefixed(messageABuf.Bytes, ref offsetA, passwordSpan);
            WriteLengthPrefixed(messageABuf.Bytes, ref offsetA, pinSpan);
            WriteLengthPrefixed(messageABuf.Bytes, ref offsetA, factorA);

            int offsetB = 0;
            WriteLengthPrefixed(messageBBuf.Bytes, ref offsetB, domainB);
            WriteLengthPrefixed(messageBBuf.Bytes, ref offsetB, passwordSpan);
            WriteLengthPrefixed(messageBBuf.Bytes, ref offsetB, pinSpan);
